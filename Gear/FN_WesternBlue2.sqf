...
switch (_type) do {
	...
	case "B_CTRG_Soldier_AR_tna_F": {
		...
		_obj addVest (selectRandom ["V_PlateCarrier1_tna_F","V_PlateCarrier2_tna_F","V_PlateCarrier1_tna_F","V_PlateCarrier2_tna_F","V_PlateCarrier1_tna_F","V_PlateCarrier2_tna_F","V_PlateCarrierGL_tna_F","V_PlateCarrierSpec_tna_F"]);
		_obj addHeadgear "H_HelmetB_Enh_tna_F";
		_obj addGoggles (selectRandom ["","","","","","","G_Combat","G_Combat_Goggles_tna_F","G_Lowprofile"]);
	...
	case "B_engineer_F": {
		...
		_obj addVest (selectRandom ["V_PlateCarrier1_tna_F","V_PlateCarrier2_tna_F","V_PlateCarrierGL_blk","V_PlateCarrierSpec_blk"]);
		_obj addHeadgear "H_HelmetB_Enh_tna_F";
		_obj addGoggles (selectRandom ["","","","","","","G_Combat","G_Combat_Goggles_tna_F","G_Lowprofile"]);
		for "_i" from 1 to 8 do {_obj addItemToVest "30Rnd_556x45_Stanag";};
		for "_i" from 1 to 4 do {_obj addItemToVest "SmokeShell";};
	...
	case "B_HeavyGunner_F": {
		_obj forceAddUniform "U_B_T_Soldier_F";
		_obj addVest (selectRandom ["V_PlateCarrier1_tna_F","V_PlateCarrier2_tna_F","V_PlateCarrier1_tna_F","V_PlateCarrier2_tna_F","V_PlateCarrier1_tna_F","V_PlateCarrier2_tna_F","V_PlateCarrier1_tna_F","V_PlateCarrier2_tna_F","V_PlateCarrierGL_tna_F","V_PlateCarrierGL_rgr","V_PlateCarrierSpec_mtp","V_PlateCarrierSpec_rgr"]);
		_obj addHeadgear "H_HelmetB_Enh_tna_F";
		_obj addGoggles (selectRandom ["","","","","","","G_Combat","G_Combat_Goggles_tna_F","G_Lowprofile"]);
	...
	case "B_recon_exp_F": {
		...
		_obj addVest (selectRandom ["V_PlateCarrier1_tna_F","V_PlateCarrier2_tna_F"]);
		_obj addHeadgear "H_HelmetB_Enh_tna_F";
		for "_i" from 1 to 8 do {_obj addItemToVest "30Rnd_556x45_Stanag";};
		for "_i" from 1 to 4 do {_obj addItemToVest "SmokeShell";};
		_obj addBackpack (selectRandom ["B_AssaultPack_blk","B_AssaultPack_cbr","B_AssaultPack_tna_F","B_AssaultPack_rgr"]);
	...
	case "B_soldier_AR_F": {
		...
		_obj addHeadgear "H_HelmetB_Enh_tna_F";
		_obj addGoggles (selectRandom ["","","","","","","G_Combat","G_Combat_Goggles_tna_F","G_Lowprofile"]);
		for "_i" from 1 to 3 do {_obj addItemToVest "150Rnd_556x45_Drum_Mag_F";};
		for "_i" from 1 to 4 do {_obj addItemToVest "SmokeShell";};
		_obj addWeapon "arifle_SPAR_02_blk_F";
		_obj addPrimaryWeaponItem "optic_Aco";
	};
